...
#  it's recursive data about data, meaning the data about our tables, and the data about the data in those tables
meta = MetaData(db)
...
with db.connect() as connection:
    ...
    # Query 2 - select only the "Name" column from the "Artist" table, .c will identify specific column header.
